...
> **Update, September 2026.** The experiment framework described here has since been removed from the site. The post stays as written; the code samples show the framework as it was.
