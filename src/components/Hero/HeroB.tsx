...
// Hero variant B — same as HeroA but with the dense meta-paragraph
// removed. Hypothesis: the long descriptive paragraph (VMware /
// TestGorilla / Octopus Energy / CData Virtuality / RAG / NL→SQL /
// Cursor-style copilot) is the visual + cognitive bottleneck that
// makes 77% of visitors leave from the hero before scrolling to the
// work section.
//
// We change ONE thing — drop that paragraph — so the success/failure
// signal can be attributed cleanly. Everything else (pill, role line,
// CTAs, geography) stays identical to HeroA.
//
// Note the duplication between HeroA and HeroB. Intentional — these
// are deliberately two snapshots in time, not a parameterised
// component. When the experiment concludes, the loser gets deleted
// and the winner becomes the canonical Hero again.
    ...
    >
      ...
      <div className="relative flex w-full items-center gap-10 lg:gap-16">
        ...
        <motion.p
          ...
          initial="hidden"
          animate="visible"
          className="mb-10 text-2xl text-muted md:text-3xl"
        >
        ...
        {/*
          HeroB drop: the dense meta-paragraph that lived here in HeroA
          listing VMware / TestGorilla / Octopus Energy / CData Virtuality
          and the RAG / NL→SQL / Cursor-style copilot work. The CV link
          below still surfaces this depth for visitors who want it.
        */}
