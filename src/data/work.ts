...
export const projects: Project[] = [
  {
    ...
    description:
      'Insight Draft turns meeting recordings into searchable team knowledge — instant summaries, action items, and a Q&A assistant grounded in the transcript with verified citations. Under the hood: real-time speaker-attributed transcription via Deepgram, AI summaries with topic chapters, RAG-powered Q&A, AI Quick Actions for decisions, conversation analytics (speaking time, interruptions, turn-taking), and a custom prompt framework. Built solo from API to UI: .NET 8 backend, a dedicated Node.js LLM service orchestrating GPT-5-mini + Claude 3.5 across RAG, zero-shot, and moderation endpoints, and an Angular 21 client. Multi-environment Jenkins CI/CD, Stripe billing, S3 storage, Playwright E2E.',
    metrics: [
      { value: '2 LLMs', label: 'multi-provider — GPT-5-mini primary, Claude 3.5 secondary' },
      { value: 'RAG', label: 'Q&A grounded in transcripts with verified citations' },
      { value: 'Solo', label: 'API · LLM service · UI · CI/CD · live in production' },
    ],
    tech: ['.NET 8', 'Node.js', 'Angular 21', 'OpenAI', 'Claude', 'Deepgram', 'RAG', 'Vector stores', 'PostgreSQL', 'Stripe', 'AWS S3', 'Jenkins', 'Playwright'],
